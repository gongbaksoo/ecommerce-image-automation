...
export async function POST(request: NextRequest) {
  try {
    ...
    const systemPromptParts = [
      ...
      PRODUCT_IMAGE_RULE,
      `[BACKGROUND RULE] The background/scene/environment MUST fill the ENTIRE image edge-to-edge. Do NOT leave any blank, white, or empty areas. The background should be a complete, natural scene.`,
      textPositionGuide ? `[PRODUCT PLACEMENT] ${textPositionGuide}` : '',
