...
| FR-02-2 | 문구 영역 전체에 통합 배경(단색/그라데이션/블러)을 설정할 수 있다 | Medium | ✅ Done |
...
| FR-09-1 | 미리보기 옆에 실시간 HTML 코드 패널이 표시되고 복사할 수 있다 | Medium | ✅ Done |
...
| 0.5 | 2026-03-23 | 문구 통합 배경 추가(FR-02-2: 단색/그라데이션/블러). AI 프롬프트 개선: 배경 전체 채움 + 상품 위치만 조절 | jeongjihye |
| 0.6 | 2026-03-23 | HTML 코드 패널 추가(FR-09-1). 3단 레이아웃(설정/미리보기/코드). 배경-콘텐츠 레이어 분리(문구 고정). 크롭↔미리보기 동기화(bgImageNatW/H) | jeongjihye |
